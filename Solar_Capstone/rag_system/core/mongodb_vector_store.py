...
class MongoDBVectorStore:
 ...
 existing_indexes = self.db.list_collection_names()
 if "vector_embeddings" in existing_indexes:
 ...
 print(f"ℹ Vector search index may already exist: {e}")
 except Exception as e:
 ...
 print(f" Document added to MongoDB: {document_data['file_name']}")
 return True
 ...
 embeddings = []
 for chunk in chunks:
 # Basic features: length, word count, character distribution
 features = [
 len(chunk),
 len(chunk.split()),
 chunk.count(' '),
